...
public class CruddemoApplication {
    ...
    private void queryAllLastNames(StudentDAO studentDAO) {
        List<String> lastNames = studentDAO.findAllLastNames();

        System.out.println("All student last names:");
